<?php
/*
 *  Code igniter library to integrate with Jaisen Mathai's
 *  Foursquare's PHP oauth library inside a single Codeigniter library
 *  Full documentation coming
 *  Currently use the attached README
 *  Uses the MY_Input Hack by Jamie Rubelow <http://www.jamierumbelow.net>
 *  @license GPLv3
 *  @version 1.0.0
 *  @author Somnath Mitra <shomnat@yahoo.com>
 */
/*
 ...
 */
class Foursquare extends EpiOAuth
{
